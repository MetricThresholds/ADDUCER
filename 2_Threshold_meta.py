...
For each OO metric on 65 projects, five supervised methods derived five thresholds.

So, there are 65*5=325 samples to perform meta-analysis.
...
def pool_meta(working_dir, result_dir):
    ...
    for metric in metrics:
        ...
        for line in lines_all:
            ...
            for root, dirs, files in os.walk(metric_dir + project):
                for name in files:
                    ...
                    df_name = pd.read_csv(metric_dir + project + '\\' + name, index_col=False, keep_default_na=False,
                                          na_values=[""])
                    # print(df_name.head())
                    # print(df_name[df_name['metric'] == metric])
                    # print(metric not in df_name.metric.values)
            ...
            # print(bender_t)
            # print(np.mean(bender_t), np.var(bender_t))
            ...
            # print(auc_t)
            # print(np.mean(auc_t), np.var(auc_t))
            ...
            # print(gm_t)
            # print(np.mean(gm_t), np.var(gm_t))
            ...
            # print(bpp_t)
            # print(np.mean(bpp_t), np.var(bpp_t))
            ...
            # print(mfm_t)
            # print(np.mean(mfm_t), np.var(mfm_t))
        ...
        # print(bender_t_effects)
        # print(bender_t_variances)
        # print(auc_t_effects)
        # print(auc_t_variances)
        # print(gm_t_effects)
        # print(gm_t_variances)
        # print(bpp_t_effects)
        # print(bpp_t_variances)
        # print(mfm_t_effects)
        # print(mfm_t_variances)
        # print(threshold_effects)
        # print(threshold_variances)
